...
Filtering by score
-------------------
Some genome annotation tracks have "score" column, generally indicating the strength of measured signal within genomic regions. Sometimes we want to consider only genomic regions with high signal, ignoring those with low signal.
...
The **-o** parameter starts processing of the unfiltered database.
